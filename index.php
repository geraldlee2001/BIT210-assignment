...
<body id="page-top">
  ...
  <section class="page-section bg-light" id="portfolio">
    <div class="container">
      <div class="text-center">
        <h2 class="section-heading text-uppercase">Recommended Place</h2>
        <h3 class="section-subheading text-muted">
          Some recommended travel place in Malaysia that you would like to go.
        </h3>
      </div>
      <div class="row">
        <div class="col-lg-4 col-sm-6 mb-4">
          ...
          <div class="portfolio-item">
            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal1">
              ...
              <img class="img-fluid" src="assets/img/portfolio/1.jpg" alt="Sunway Lagoon" />
            </a>
            <div class="portfolio-caption">
              <div class="portfolio-caption-heading">Sunway Lagoon</div>
